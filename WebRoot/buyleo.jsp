...
<!-- 在baseServlet中加判断当请求的地址是以.jsp结尾时 调用方法 responseHeaderInfo;目前没有找到更好的解决方法-->
	...
	<div class="register_account">
		<form action="confirmOrder.do" method="post" id="multiFormSubmit">
			...
			<br/>
			<div class="wrap">
				<h4 class="title">商品清单<a href="leoCart.do">[返回购物车修改]</a></h4>
			</div>
					...
					<tbody>
						...
						<tr>
							<td style="width:100px;">
								<a target="_blank" href="getProduct.do?productid=${cartProduct.value.productId }">
							...
							<td >
								...
								<i><a target="_blank" href="getProduct.do?productid=${cartProduct.value.productId }">

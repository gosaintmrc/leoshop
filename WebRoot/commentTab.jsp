	...
	<div class="mycar-index">
		<c:forEach items="${commentMsgs}" var="commentMsg">
			<c:choose>
							...
							<table cellspacing="1.5">
								...
								<tr>
									...
									<td width="425px" align="left">
										...
										<div class="pname"><a target="_blank" href="getProduct.do?productid=${commentMsg.productId }">${commentMsg.productName}</a></div>
									</td>
				...
				<c:otherwise>
					<div id="cart-wrapper">
						<form action="submitComment.do" method="post">
							<table cellspacing="1.5">
								<thead>
								<tr>
									<th width="100px">订单编号</th>

		...
		<div class="wrap">
			<div class="section group">
				...
				<br/><br/><br/>
					...
					<c:if test="${pager.currPage>1 }">
					<a class="pageturn" href="getAllProduct.do?currPage=1">首页</a>&nbsp;&nbsp;
					<a class="pageturn" href="getAllProduct.do?currPage=${pager.currPage-1}">上一页</a>&nbsp;&nbsp;
					</c:if>
					<c:if test="${pager.currPage==pager.pageCount}">
   					          下一页&nbsp;&nbsp;尾页
   					</c:if>
					<c:if test="${pager.currPage<pager.pageCount}">
					<a class="pageturn" href="getAllProduct.do?currPage=${pager.currPage+1}">下一页</a>&nbsp;&nbsp;				
					<a class="pageturn" href="getAllProduct.do?currPage=${pager.pageCount}">尾页</a>&nbsp;&nbsp;
					</c:if>
